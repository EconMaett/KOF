# ************************************************************************
# KOF Consensus EUR-CHF Exchange Rate ----
# ************************************************************************
...
ggsave(filename = "Indicators/KOF_Consensus/Exchange-Rates/EUR-CHF/Fig_KOF_Consensus-EUR-CHF_03m.png", width = 8, height = 4)
graphics.off()
...
ggsave(filename = "Indicators/KOF_Consensus/Exchange-Rates/EUR-CHF/KOF_Consensus-EUR-CHF_12m.png", width = 8, height = 4)
graphics.off()
